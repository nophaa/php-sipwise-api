...
class Calls extends AbstractApi
{
    ...
    {
        //allowed values
        $status = ['ok', 'busy', 'noanswer', 'cancel', 'offline', 'timeout', 'other'];
        $rated = ['oke', 'unrated', 'failed'];
        $type = ['call', 'cfu', 'cfb', 'cft', 'cfna', 'cfs'];
        ...
        $resolver->setDefined('customer_id')
            ->setAllowedTypes('customer_id', ['string', 'integer']);
        ...
        $resolver->setDefined('direction')
            ...
            ->setAllowedValues('direction', ['in', 'out']);
        ...
        $resolver->setDefined('call_id')
            ->setAllowedTypes('call_id', ['integer', 'string']);

        $resolver->setDefined('own_cli')
            ->setAllowedTypes('own_cli', ['integer', 'string']);
